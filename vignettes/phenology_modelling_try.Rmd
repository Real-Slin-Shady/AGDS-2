...
```{r, message = FALSE}
packages <- c("phenocamr","dplyr","ggplot2","lubridate","daymetr","leaflet","terra","MODISTools","daymetr","renv") 
...
```
Alright, looks much better. Still the RMSE remains very high. Therefore, I expect that mainly the yearly signal correlates and the spatial still does not.
