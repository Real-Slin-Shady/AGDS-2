...
## Readin and data processing as in excercise
...
mean(mod_random_cv$resample$RMSE)
mean(mod_random_cv$resample$Rsquared)
...
What do you observe? Discuss the potential implications of the geographical distribution of data points for spatial upscaling. -\> Heavy clustering in Europe and SE-Asia. Almost no sites in America or Africa

## Spatial corss-validation
...
Split your data into five folds that correspond to the geographical clusters identified by in (2.), and fit a random forest model with the same hyperparameters as above and performing a 5-fold cross-validation with the clusters as folds. Report the RMSE and the R determined on each of the five folds
